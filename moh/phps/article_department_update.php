...
if(isset($_POST["serial_no"]) && !empty(trim($_POST["serial_no"])))
{
    ...
    $sql = "UPDATE article_department SET 
	person_id='".$person_id."',
...
elseif(isset($_GET["serial_no"]) && !empty(trim($_GET["serial_no"]))){
	$sql = "SELECT * FROM article_department WHERE serial_no = ".$_GET["serial_no"];
	//echo $sql;-
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <a href="article_department_index.php" class="btn btn-default">Cancel</a>
                    </form>
                </div>
            </div>        
        </div>
