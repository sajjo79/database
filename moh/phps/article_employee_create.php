...
$serial_no = $person_id = $input_remarks = $input_description = "";
$serial_no_err = $person_id_err = $input_remarks_err = $input_description_err= "";
$query_error = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(
        ...
        $sql = "INSERT INTO article_employee (serial_no, person_id, remarks, description) 
		VALUES (".$serial_no.",'".$person_id."','".$input_remarks."','".$input_description."')";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please fill this form and submit to add Article_Employee record to the database.</p>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					   ...
					   <div class="form-group <?php echo (!empty($person_id_err)) ? 'has-error' : ''; ?>"> 
						...
						<div class="form-group"> 
                            <label>Remarks</label>
                            <input type="text" name="remarks" class="form-control" value="<?php echo $input_remarks; ?>">
                        ...
                        <a href="article_employee_index.php" class="btn btn-default">Back to Index</a>
						<div class="form-group"	>
